...
namespace NPMReps {
    public partial class RepShiftPerfMX : System.Web.UI.Page {
        ...
        protected void Page_Load(object sender, EventArgs e) {
            ...
            if (IsPostBack) {
                ...
                if (Session[pageName] != null) data = Session[pageName] as RepShiftPerfMXData;
            }
            else {
            ...
            if (data == null) {
                if (Application[pageName] == null) {
                    Application[pageName] = data = new RepShiftPerfMXData();
                    ...
                    RepShiftPerfMXData appData = Application[pageName] as RepShiftPerfMXData;
        ...
        private static RepShiftPerfMXData CloneData(RepShiftPerfMXData source) {
            IFormatter formatter = new BinaryFormatter();
            Stream stream = new MemoryStream();
            using (stream) {
                formatter.Serialize(stream, source);
                stream.Seek(0, SeekOrigin.Begin);
                return (RepShiftPerfMXData)formatter.Deserialize(stream);
            }
        }
