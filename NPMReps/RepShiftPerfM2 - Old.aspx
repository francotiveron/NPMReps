<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RepShiftPerfM2 - Old.aspx.cs" Inherits="NPMReps.RepShiftPerfMX" %>
       ...
       <asp:HiddenField ID="UserName" runat="server" ClientIDMode="Static"></asp:HiddenField>
        ...
        <asp:UpdateProgress ID="UpdateProgress1" runat="server">
            ...
            <asp:Table ID="Table" runat="server" Height="20px" CellPadding="2" CellSpacing="0" Width="100%">
                ...
                <asp:TableRow LowerInit="500" UpperInit="510" PrtFmt="000" ID="ML03TPHRow" PITag="WTWT5s" PIFilter="'WTWT5s'>100" runat="server">
                ...
                <asp:TableRow LowerInit="94" UpperInit="98" PrtFmt="00.0" ID="ML03CurrentRow" PITag="ML03_Load" PIFilter="'ML03_Load'>50" runat="server">
                ...
                <asp:TableRow LowerInit="81" UpperInit="85" PrtFmt="00.0" ID="ML03SoundRow" PITag="ML03Snd" PIFilter="'ML03Snd'>50" runat="server">
                ...
                <asp:TableRow LowerInit="72" UpperInit="85" PrtFmt="00.0" ID="ML03DensityRow" PITag="PLC13_PD16SgSolSP" PIFilter="'PLC13_PD16SgSolSP'>50" runat="server">
                ...
                <asp:TableRow LowerInit="73" UpperInit="83" PrtFmt="00" ID="CY04PressureRow" PITag="PTCY4s" PIFilter="'PTCY4s'>10" runat="server">
                ...
                <asp:TableRow LowerInit="65" UpperInit="72" PrtFmt="00.0" ID="CY04DensityRow" PITag="DTCY4s" PIFilter="'DTCY4s'>10" runat="server">
                ...
                <asp:TableRow LowerInit="4930" UpperInit="10000" PrtFmt="0000" ID="ML04PowerRow" PITag="ML04_W" PIFilter="'ML04_W'>100" runat="server">
                ...
                <asp:TableRow LowerInit="120" UpperInit="150" PrtFmt="000" ID="CY06PressureRow" PITag="PTCY06s" PIFilter="'PTCY06s'>10" runat="server">
                ...
                <asp:TableRow LowerInit="50" UpperInit="56" PrtFmt="00.0" ID="CY06DensityRow" PITag="DITCY06s" PIFilter="'DITCY06s'>10" runat="server">
                ...
                <asp:TableRow LowerInit="1420" UpperInit="10000" PrtFmt="0000" ID="ML06PowerRow" PITag="ML06_W" PIFilter="'ML06_W'>100" runat="server">
                ...
                <asp:TableRow LowerInit="33" UpperInit="38" PrtFmt="00.0" ID="TK36DensityRow" PITag="DTT36s" PIFilter="'WTWT5s'>100" runat="server">
                ...
                <asp:TableRow LowerInit="80" UpperInit="155" PrtFmt="000" ID="FT27PressureRow" PITag="PTF27s" PIFilter="'PTF27s'>5" runat="server">
                ...
                <asp:TableRow LowerInit="32.5" UpperInit="34.5" PrtFmt="00.0" ID="FinalConRow" PITag="OSA_M2_FC_CU_PI" PIFilter="'OSA_M2_FC_CU_PI'>1" runat="server">
                ...
                <asp:TableRow LowerInit="0.10" UpperInit="0.24" PrtFmt="0.00" ID="FloatFeedRow" PITag="OSA_M2_FF_CU_PI" runat="server">
                ...
                <asp:TableRow LowerInit="30" UpperInit="33" PrtFmt="00.0" ID="FlashFloatConRow" PITag="OSA_M2_FFC_CU_PI" runat="server">
                ...
                <asp:TableRow LowerInit="0.05" UpperInit="0.11" PrtFmt="0.000" ID="FinalTailRow" PITag="OSA_M2_FT_CU_MX3_PI" runat="server">
